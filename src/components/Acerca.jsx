...
const Acerca = () => {
  return (
    <div className='acercaContainer' id='acercade'>
      ...
      <div className="infoEvento">
        <img src="/img/holifest.jpg" alt="colorfest" />
        <p>
          Prepárate para una experiencia única, donde podrás disfrutar de la combinación perfecta de música y diversión acuática.
        </p>
      </div>
